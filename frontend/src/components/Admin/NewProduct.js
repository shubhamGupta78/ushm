...
import { clearErrors, createProductRequest } from "../../actions/adminActions";
...
console.log("lo value is"+loading);
console.log("lo value is"+error);
console.log("lo value is"+product);
    ...
    dispatch(createProductRequest(myForm));
    }
